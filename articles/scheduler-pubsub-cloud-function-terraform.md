...
:::message
※1:
実際には、Cloud BuildからCloud Functionsにデプロイされますが、この辺りの構築プロセスはユーザーが意識する必要のない作りになっています。Cloud Functionsのデプロイにはいくつか手法がありますが、代表的な「Cloud Storageからデプロイ」の場合、実際には以下のプロセスで動作をしています。
...
https://github.com/harusys/techblog/samples/scheduler-pubsub-cloud-function-terraform
